...
var SubMenu = function (_a) {
    ...
    var renderChildren = function () {
        ...
        return (React.createElement(Transition, { animation: "zoom-in-left", in: menuOpen, timeout: 300 },
            React.createElement("ul", { className: subMenuClasses }, childrenComponent)));
    };
    return (React.createElement("li", __assign({ key: index, className: classes, onClick: handleClick }, hoverEvents),
